...
{
    public class BaseUserDefinedAttrEx
    {
        public enum UDA_DATA_TYPE { INTEGER = 1, DATE = 2, DATETIME = 3, BOOLEAN = 4, STRING = 5, FLOAT = 6, SETTING = 7, LINKED = 8 }
        public BaseUserDefinedAttrEx(string udaKey, string udaName, string udaDataType, string udaDescription)
        {
            _udaKey = udaKey;
            _udaName = udaName;
        ...
        public BaseUserDefinedAttrEx(string udaKey, string udaName, UDA_DATA_TYPE dataType, string udaDescription)
        {
            _udaKey = udaKey;
            _udaName = udaName;
