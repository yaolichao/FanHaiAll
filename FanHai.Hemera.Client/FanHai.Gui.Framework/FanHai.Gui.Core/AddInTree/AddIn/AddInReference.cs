    ...
    public class AddInReference : ICloneable
    {
        ...
        public static AddInReference Create(Properties properties, string hintPath)
        {
            ...
            if (version != null && version.Length > 0)
            {
                ...
                if (reference.Name == "FanHai.Gui.Framework.StartUp")
                {
                    // HACK: SD 3.0 AddIns work with FanHai.Hemera 3.1
                    // Because some 3.0 AddIns restrict themselves to FanHai.Hemera 3.0, we extend the
                    // supported SD range.
        ...
        internal static Version ParseVersion(string version, string hintPath)
        {
            ...
            {
                if (version == "@SolarViewerCoreVersion")
                {
