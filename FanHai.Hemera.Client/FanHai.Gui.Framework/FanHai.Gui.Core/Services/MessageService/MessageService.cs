...
namespace FanHai.Gui.Core
{
    ...
    public static class MessageService
    {
        ...
        /// <summary>
        /// Asks the user a Yes/No question, using "No" as the default button.
        /// Returns <c>true</c> if yes was clicked, <c>false</c> if no was clicked.
        /// </summary>
        /// <param name="question"></param>
        /// <param name="caption"></param>
        /// <returns></returns>
        /// Owner:Andy Gao 2011-08-11 09:41:49
        public static bool AskQuestionSpecifyNoButton(string question, string caption)
        {
            return ServiceManager.MessageService.AskQuestionSpecifyNoButton(question, caption);
        }
        ...
        /// <param name="question"></param>
        /// <returns></returns>
        /// Owner:Andy Gao 2011-08-11 09:43:09
        public static bool AskQuestionSpecifyNoButton(string question)
        {
            return AskQuestionSpecifyNoButton(StringParser.Parse(question), StringParser.Parse("${res:Global.QuestionText}"));
        }
        ...
        /// <summary>
        /// Gets/Sets the name of the product using FanHai.Gui.Core
