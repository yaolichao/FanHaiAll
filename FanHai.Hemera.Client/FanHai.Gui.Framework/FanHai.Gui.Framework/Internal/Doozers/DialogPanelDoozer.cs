...
namespace FanHai.Gui.Framework
{
    ...
    /// In the SolarViewerFramework options, option pages can have subpages by specifying them
    /// as children in the AddInTree.
    /// </children>
    /// <usage>In /SolarViewerFramework/BackendBindings/ProjectOptions/ and /SolarViewerFramework/Dialogs/OptionsDialog</usage>
    /// <returns>
