    ...
    sealed class SimpleWorkbenchLayout : IWorkbenchLayout
    {
        ...
        sealed class SimpleDocumentTab : TabPage
        {
            ...
            public SimpleDocumentTab()
            {
                ...
                closeButton.ContextMenuStrip = MenuService.CreateContextMenu(window, "/FanHaiFramework/Workbench/OpenFileTab/ContextMenu");
        ...
        sealed class SimpleWorkbenchWindow : Control, IWorkbenchWindow, IOwnerState
        {
            ...
            /// <summary>
            /// Confirm Select specified Window
            /// </summary>
            /// <param name="question"></param>
            /// <returns></returns>
            /// Owner:Andy Gao 2011-04-13 11:43:50
            public bool ConfirmSelectWindow(string question)
            {
                Show();
                    ...
                    switch (dr)
                    {
                        case DialogResult.Yes:
                            foreach (IViewContent vc in this.ViewContents)
                            {
                                ...
                                //    while (true)
                                //    {
                                //        vc.Files.ForEach(FanHai.Gui.Framework.Commands.SaveFile.Save);
                                //        if (vc.IsDirty)
                                //        {
