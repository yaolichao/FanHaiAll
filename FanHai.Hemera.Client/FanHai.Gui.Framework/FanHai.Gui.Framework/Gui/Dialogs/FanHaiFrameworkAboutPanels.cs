...
{
    public class AboutSolarViewerFrameworkTabPage : UserControl
    {
        ...
        public AboutSolarViewerFrameworkTabPage()
        {
        ...
        public static string LicenseSentence
        {
            get
            {
                return StringParser.Parse("${res:Dialog.About.License}",
                                          new string[,] { { "License", "2011 Coryright FanHai" } });
            }
        }
        ...
        {
            string str = "";
            Version v = typeof(AboutSolarViewerFrameworkTabPage).Assembly.GetName().Version;
            str += "MES Framework Version  : " + v.ToString() + Environment.NewLine;
            str += ".NET Framework Version : " + Environment.Version.ToString() + Environment.NewLine;
