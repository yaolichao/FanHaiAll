...
namespace FanHai.Gui.Framework.Gui
{
    ...
    /// </summary>
    public class TreeViewOptions : BaseSolarViewerFrameworkpForm
    {
        ...
        protected void InitializeComponent()
        {
            ...
            SetupFromXmlStream(this.GetType().Assembly.GetManifestResourceStream("FanHai.Gui.Framework.Resources.TreeViewOptionsDialog.xfrm"));
