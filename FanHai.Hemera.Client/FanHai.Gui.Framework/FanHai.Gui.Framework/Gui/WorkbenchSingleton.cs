    ...
    public static class WorkbenchSingleton
    {
        ...
        static void TrackPropertyChanges(object sender, PropertyChangedEventArgs e)
        {
            if (e.OldValue != e.NewValue && workbench != null)
            {
                switch (e.Key)
                {
                    case "FanHai.Gui.Framework.Gui.StatusBarVisible":
                    //case "FanHai.Gui.Framework.Gui.VisualStyle":
                    case "FanHai.Gui.Framework.Gui.ToolBarVisible":
                        workbench.RedrawAllComponents();
                        break;
                    case "FanHai.Gui.Framework.Gui.UseProfessionalRenderer":
        ...
        /// Is called by FanHai.Gui.Framework.Sda and should not be called manually!
        /// </summary>
...
//            Project.ProjectService.InitializeService();
        ...
        public static int RemoveXButton(int iHWND)
        {
            ...
            iSysMenu = GetSystemMenu(WorkbenchSingleton.MainForm.Handle.ToInt32(), 0);
