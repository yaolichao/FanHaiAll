...
namespace FanHai.Gui.Framework.BrowserDisplayBinding
{
    ...
    public class HtmlViewPane : UserControl
    {
        ...
        public static ISchemeExtension GetScheme(string name)
        {
            if (descriptors == null)
            {
                descriptors = AddInTree.BuildItems<SchemeExtensionDescriptor>("/FanHaiFramework/Views/Browser/SchemeExtensions", null, false);
            }
        ...
        public const string DefaultHomepage = "about:blank";
