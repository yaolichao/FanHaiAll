...
{
	sealed class SaveErrorChooseDialog : Form 
	{
		Button  retryButton;
		Button  ignoreButton;
		...
		{
            MessageService.ShowMessage(exceptionGot.ToString(), StringParser.Parse("${res:FanHai.Gui.Core.Services.ErrorDialogs.ExceptionGotDescription}"));
		}
		...
		private void InitializeComponents(bool chooseLocationEnabled) 
		{
            ...
            this.descriptionLabel.Text = StringParser.Parse("${res:FanHai.Gui.Core.Services.ErrorDialogs.DescriptionLabel}");
            ...
            this.exceptionButton.Text = ResourceService.GetString("FanHai.Gui.Core.Services.ErrorDialogs.ShowExceptionButton");
