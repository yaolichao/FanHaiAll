    ...
    public sealed class WinFormsMessageService : IMessageService
    {
        ...
        public void ShowError(Exception ex, string message)
        {
            ...
            BeginInvoke(
                delegate
                {
                    MessageBox.Show(DialogOwner, message, caption, MessageBoxButtons.OK, MessageBoxIcon.Error);
                });
        }
        ...
        /// <summary>
        /// Display Ask Yes/No Question Message Box And Specify No Button
        /// </summary>
        /// <param name="question"></param>
        /// <param name="caption"></param>
        /// <returns></returns>
        /// Owner:Andy Gao 2011-08-11 09:40:04
