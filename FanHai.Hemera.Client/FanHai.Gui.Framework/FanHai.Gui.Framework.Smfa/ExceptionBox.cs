...
{
    /// <summary>
    /// Form used to display display unhandled errors in SolarViewerFramework.
    /// </summary>
    public class ExceptionBox : Form
    {
        ...
        {
            if (MessageBox.Show(StringParser.Parse("${res:FanHai.Gui.Framework.ExceptionBox.QuitWarning}"), MessageService.ProductName, MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button2, MessageBoxOptions.DefaultDesktopOnly)
                == DialogResult.Yes)
            {
                Application.Exit();
            }
        ...
        void InitializeComponent()
        {
            ...
            this.closeButton.Text = "${res:FanHai.Gui.Framework.ExceptionBox.Exit}";
            ...
            this.label3.Text = "${res:FanHai.Gui.Framework.ExceptionBox.ThankYouMsg}";
            // 
            // label2
            // 
            ...
            this.label2.Text = "${res:FanHai.Gui.Framework.ExceptionBox.HelpText2}";
            // 
            // label
            // 
            ...
            this.label.Text = "${res:FanHai.Gui.Framework.ExceptionBox.HelpText1}";
            // 
            // continueButton
            // 
            ...
            this.continueButton.Text = "${res:FanHai.Gui.Framework.ExceptionBox.Continue}";
            ...
            this.reportButton.Text = "${res:FanHai.Gui.Framework.ExceptionBox.ReportError}";
            ...
            this.copyErrorCheckBox.Text = "${res:FanHai.Gui.Framework.ExceptionBox.CopyToClipboard}";
            // 
            // exceptionTextBox
            // 
            ...
            this.Text = "${res:FanHai.Gui.Framework.ExceptionBox.Title}";
