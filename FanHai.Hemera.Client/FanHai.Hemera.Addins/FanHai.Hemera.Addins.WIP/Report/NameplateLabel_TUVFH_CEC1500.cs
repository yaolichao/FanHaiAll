...
{
    public partial class NameplateLabel_TUVFH_CEC1500 : DevExpress.XtraReports.UI.XtraReport
    {
        public NameplateLabel_TUVFH_CEC1500(PrintLabelParameterData data)
        {
            InitializeComponent();
        }
        public NameplateLabel_TUVFH_CEC1500(string code, string _voc, 
