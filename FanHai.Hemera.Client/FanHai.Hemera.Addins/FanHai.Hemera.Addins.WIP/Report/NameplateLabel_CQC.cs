...
{
    public partial class NameplateLabel_CQC : DevExpress.XtraReports.UI.XtraReport
    {
        public NameplateLabel_CQC(PrintLabelParameterData data)
        {
            InitializeComponent();
        }
        public NameplateLabel_CQC(string code, string _voc, 
