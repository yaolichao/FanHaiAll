...
{
    public partial class NameplateLabel_ASM : DevExpress.XtraReports.UI.XtraReport
    {
        public NameplateLabel_ASM(PrintLabelParameterData data)
        {
            InitializeComponent();
        }
        public NameplateLabel_ASM(string code, string _voc, 
