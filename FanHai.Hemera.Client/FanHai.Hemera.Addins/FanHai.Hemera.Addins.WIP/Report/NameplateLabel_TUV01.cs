...
{
    public partial class NameplateLabel_TUV01 : DevExpress.XtraReports.UI.XtraReport
    {
        public NameplateLabel_TUV01(PrintLabelParameterData data)
        {
            InitializeComponent();
        }
        public NameplateLabel_TUV01(string code, string _voc, 
