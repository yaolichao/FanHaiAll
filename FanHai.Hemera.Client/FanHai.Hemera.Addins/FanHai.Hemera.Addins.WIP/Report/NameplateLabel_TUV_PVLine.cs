...
{
    public partial class NameplateLabel_TUV_PVLINE : DevExpress.XtraReports.UI.XtraReport
    {
        public NameplateLabel_TUV_PVLINE(PrintLabelParameterData data)
        {
            InitializeComponent();
        }
        public NameplateLabel_TUV_PVLINE(string code, string _voc, 
