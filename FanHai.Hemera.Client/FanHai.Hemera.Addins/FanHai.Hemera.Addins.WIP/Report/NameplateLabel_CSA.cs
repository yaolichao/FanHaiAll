...
{
    public partial class NameplateLabel_CSA : DevExpress.XtraReports.UI.XtraReport
    {
        public NameplateLabel_CSA(PrintLabelParameterData data)
        {
            InitializeComponent();
        }
        public NameplateLabel_CSA(string code, string _voc, 
