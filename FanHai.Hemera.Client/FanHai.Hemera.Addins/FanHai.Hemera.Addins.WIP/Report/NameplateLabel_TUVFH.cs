...
{
    public partial class NameplateLabel_TUVFH : DevExpress.XtraReports.UI.XtraReport
    {
        public NameplateLabel_TUVFH(PrintLabelParameterData data)
        {
            InitializeComponent();
        }
        public NameplateLabel_TUVFH(string code, string _voc, 
