...
{
    public partial class NameplateLabel_TUV_New : DevExpress.XtraReports.UI.XtraReport
    {
        public NameplateLabel_TUV_New(PrintLabelParameterData data)
        {
            InitializeComponent();
        }
        public NameplateLabel_TUV_New(string code, string _voc, 
