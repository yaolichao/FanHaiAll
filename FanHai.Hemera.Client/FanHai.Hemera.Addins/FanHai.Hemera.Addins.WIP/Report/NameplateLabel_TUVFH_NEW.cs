...
{
    public partial class NameplateLabel_TUVFH_NEW : DevExpress.XtraReports.UI.XtraReport
    {
        public NameplateLabel_TUVFH_NEW(PrintLabelParameterData data)
        {
            InitializeComponent();
        }
        public NameplateLabel_TUVFH_NEW(string code, string _voc, 
