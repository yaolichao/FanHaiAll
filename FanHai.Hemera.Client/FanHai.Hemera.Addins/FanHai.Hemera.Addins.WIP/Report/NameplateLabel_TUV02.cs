...
{
    public partial class NameplateLabel_TUV02 : DevExpress.XtraReports.UI.XtraReport
    {
        public NameplateLabel_TUV02(PrintLabelParameterData data)
        {
            InitializeComponent();
        }
        public NameplateLabel_TUV02(string code, string _voc, 
