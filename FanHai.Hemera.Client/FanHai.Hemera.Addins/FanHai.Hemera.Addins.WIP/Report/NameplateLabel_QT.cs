...
{
    public partial class NameplateLabel_QT : DevExpress.XtraReports.UI.XtraReport
    {
        public NameplateLabel_QT(PrintLabelParameterData data)
        {
            InitializeComponent();
        }
        public NameplateLabel_QT(string code, string _voc, 
