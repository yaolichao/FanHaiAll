...
{
    public partial class NameplateLabel_CQC_AnNeng : DevExpress.XtraReports.UI.XtraReport
    {
        public NameplateLabel_CQC_AnNeng(PrintLabelParameterData data)
        {
            InitializeComponent();
        }
        public NameplateLabel_CQC_AnNeng(string code, string _voc, 
