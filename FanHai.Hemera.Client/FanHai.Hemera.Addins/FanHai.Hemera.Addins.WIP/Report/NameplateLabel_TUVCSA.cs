...
{
    public partial class NameplateLabel_TUVCSA : DevExpress.XtraReports.UI.XtraReport
    {
        public NameplateLabel_TUVCSA(PrintLabelParameterData data)
        {
            InitializeComponent();
        }
        public NameplateLabel_TUVCSA(string code, string _voc, 
