...
{
    public partial class NameplateLabel_TUVCSA1500 : DevExpress.XtraReports.UI.XtraReport
    {
        public NameplateLabel_TUVCSA1500(PrintLabelParameterData data)
        {
            InitializeComponent();
        }
        public NameplateLabel_TUVCSA1500(string code, string _voc, 
            ...
            int x,int y)
        {
            ...
            xrPicturelJT.LocationF = new PointF(xrPicturelJT.LocationF.X + x, xrPicturelJT.LocationF.Y + y);
            xrPictureTUVCSA.LocationF = new PointF(xrPictureTUVCSA.LocationF.X + x, xrPictureTUVCSA.LocationF.Y + y);
