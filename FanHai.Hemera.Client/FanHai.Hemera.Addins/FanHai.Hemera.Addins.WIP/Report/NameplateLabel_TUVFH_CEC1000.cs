...
{
    public partial class NameplateLabel_TUVFH_CEC1000 : DevExpress.XtraReports.UI.XtraReport
    {
        public NameplateLabel_TUVFH_CEC1000(PrintLabelParameterData data)
        {
            InitializeComponent();
        }
        public NameplateLabel_TUVFH_CEC1000(string code, string _voc, 
