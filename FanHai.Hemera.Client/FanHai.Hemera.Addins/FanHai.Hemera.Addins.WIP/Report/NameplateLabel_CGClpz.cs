...
{
    public partial class NameplateLabel_CGClpz : DevExpress.XtraReports.UI.XtraReport
    {
        public NameplateLabel_CGClpz(PrintLabelParameterData data)
        {
            InitializeComponent();
        }
        public NameplateLabel_CGClpz(string code, string _voc, 
            ...
            int x,int y)
        {
            ...
            xrPBox2.LocationF = new PointF(xrPBox2.LocationF.X + x, xrPBox2.LocationF.Y+y);
