...
namespace FanHai.Hemera.Addins.WIP
{
    ...
    /// 表示批次创建的窗体类。
    /// </summary>
    public partial class LotCreateNew : BaseUserCtrl
    {
        ...
        private LotCreateNewDetailModel _model = null;
        ...
        private void InitializeLanguage()
        {
            ...
            this.lciBtnClose.Text = "重置";// "关闭";
            this.lciBtnSave.Text = StringParser.Parse("${res:Global.Save}");// "保存";
            this.btnSave.Text = StringParser.Parse("${res:FanHai.Hemera.Addins.WIP.LotCreateNew.btnSave}");// "下一步";
            this.lcgTop.Text = StringParser.Parse("${res:FanHai.Hemera.Addins.WIP.LotCreateNew.lcgTop}");// "表头";
            this.lcgContent.Text = StringParser.Parse("${res:FanHai.Hemera.Addins.WIP.LotCreateNew.lcgContent}");// "内容";
            this.lcgHidden.Text = StringParser.Parse("${res:FanHai.Hemera.Addins.WIP.LotCreateNew.lcgHidden}");// "隐藏";
            this.lcgCommands.Text = StringParser.Parse("${res:FanHai.Hemera.Addins.WIP.LotCreateNew.lcgCommands}");// "命令";
            this.lciFactoryRoom.Text = StringParser.Parse("${res:FanHai.Hemera.Addins.WIP.LotCreateNew.lciFactoryRoom}");// "车间名称";
            this.lciOperation.Text = StringParser.Parse("${res:FanHai.Hemera.Addins.WIP.LotCreateNew.lciOperation}");// "工序名称";
            this.lciOrderNumber.Text = StringParser.Parse("${res:FanHai.Hemera.Addins.WIP.LotCreateNew.lciOrderNumber}");// "工单号";
            this.lciReceiveItemNo.Text = StringParser.Parse("${res:FanHai.Hemera.Addins.WIP.LotCreateNew.lciReceiveItemNo}");// "领料项目号";
            this.lciProId.Text = StringParser.Parse("${res:FanHai.Hemera.Addins.WIP.LotCreateNew.lciProId}");// "产品ID号";
            this.lciCreateType.Text = StringParser.Parse("${res:FanHai.Hemera.Addins.WIP.LotCreateNew.lciCreateType}");// "创建类别";
            this.lciCount.Text = StringParser.Parse("${res:FanHai.Hemera.Addins.WIP.LotCreateNew.lciCount}");// "投批数量";
            this.lciUserId.Text = StringParser.Parse("${res:FanHai.Hemera.Addins.WIP.LotCreateNew.lciUserId}");// "员工号";
            this.lciShiftName.Text = StringParser.Parse("${res:FanHai.Hemera.Addins.WIP.LotCreateNew.lciShiftName}");// "班别";
        }
        ...
        private void LotCreate_Load(object sender, EventArgs e)
        {
            ...
            InitControlValue();
            //lblMenu.Text = this._view.TitleName;
            lblMenu.Text = "生产管理>过站管理>生产批次(自动序列号)";
        }
        /// <summary>
        /// 初始化控件值。
        /// </summary>
