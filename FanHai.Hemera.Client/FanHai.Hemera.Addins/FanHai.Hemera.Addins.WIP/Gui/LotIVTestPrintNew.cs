...
{
    public partial class LotIVTestPrintNew : BaseUserCtrl
    {
        ...
        /// 按托号打印的批次数据
        /// </summary>
        public System.Data.DataTable dtPalletNo = null;
        /// <summary>
        /// 包装用的产品ID号
        /// </summary>
        public string PalletNoProId = string.Empty;
        public LotIVTestPrintNew()
        {
            InitializeComponent();
            InitializeLanguage();
        }
        ...
        public LotIVTestPrintNew(string lotNumber)
        {
            InitializeComponent();
        ...
        private bool CheckIVImage(PrintLabelParameterData data)
        {
            if (data.PSign != "Y" && data.IsBCPData == false)
            {
                ...
                System.Data.DataTable dtPicAddress = BaseData.GetBasicDataByCondition(cols, categoryName, lstConditions);
        ...
        private bool CheckControlParaData(PrintLabelParameterData data)
        {
            ...
            System.Data.DataTable klots = BaseData.Get(kcolumn, kcategory);
        ...
        private bool LotTrack(string lotNo, string deviceNum, string psign)
        {
            ...
            System.Data.DataTable dtPrintLableConfig = BaseData.Get(cols, BASEDATA_CATEGORY_NAME.PrintLabelConfig);
        ...
        private bool SavePrintDataToDatabase(PrintLabelParameterData data)
        {
            ...
            System.Data.DataTable dtParams = new System.Data.DataTable();
        ...
        private bool CheckFacTrueOrFalse(PrintLabelParameterData data)
        {
            ...
            System.Data.DataTable dtFac = BaseData.Get(columns, category);
            DataRow[] drs = dtFac.Select(string.Format("FAC_CODE='{0}'", data.FactoryName));
            System.Data.DataTable dt = dtFac.Clone();
        ...
        private void LotIVTestPrintNew_Load(object sender, EventArgs e)
        {
        ...
        private void LotIVTestPrintNew_Paint(object sender, PaintEventArgs e)
        {
