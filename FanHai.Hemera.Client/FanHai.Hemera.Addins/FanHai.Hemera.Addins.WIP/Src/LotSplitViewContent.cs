...
namespace FanHai.Hemera.Addins.WIP
{
    ...
    /// 拆分批次的视图类。
    /// </summary>
    public class LotSplitViewContent : AbstractViewContent
    {
        //define control
        ...
        /// 构造函数。
        /// </summary>
        public LotSplitViewContent()
            : base()
        {
            this.TitleName = StringParser.Parse("${res:FanHai.Hemera.Addins.WIP.LotSplitViewContent.Title01}");//"拆分批次";
            //define panel 
