...
namespace Astronergy.MES.Report.DataAccess
{
    ...
    /// 在制品分布数据访问。
    /// </summary>
    public class WipDisplayDataAccess_Line : BaseDBAccess
    {
        /// <summary>
        /// 车间名称。
        /// </summary>
        ...
        public bool GetWIP(ref DataTable dtChart, ref DataTable dtTable)
        {
            ...
            using (DbConnection con = this._db.CreateConnection())
            {
                ...
                cmd.CommandText = "SP_QRY_WIP_DATA_SH_TEMP";
                ...
                this._db.AddInParameter(cmd, "p_oprline", DbType.String, this.Oprline == "ALL" ? string.Empty : this.Oprline);
        ...
        public DataTable GetWIPDetail(string stepName, string status,string partNumber)
        {
            ...
            using (DbConnection con = this._db.CreateConnection())
            {
                ...
                DbCommand cmd = con.CreateCommand();
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.CommandText = "SP_QRY_WIP_DATA_DTL_SH_TEMP";
                ...
                this._db.AddInParameter(cmd, "p_oprline", DbType.String, Oprline == "ALL" ? string.Empty : Oprline);
                ds = this._db.ExecuteDataSet(cmd);
            }
            if (ds == null || ds.Tables.Count == 0)
            {
