...
public class ASPxGridViewCellMerger
{
    ...
    public bool IsNextRowHasSameData(GridViewDataColumn column, int visibleIndex)
    {
    ...
    public bool IsPrevRowHasSameData(GridViewDataColumn column, int visibleIndex)
    {
    ...
    public bool IsSameData(string fieldName, int visibleIndex1, int visibleIndex2)
    {
        // is it a group row?
