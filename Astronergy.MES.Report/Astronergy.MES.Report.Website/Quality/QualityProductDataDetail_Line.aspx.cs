...
/// 优品率报表明细数据。
/// </summary>
public partial class Quality_QualityProductDataDetail_Line : System.Web.UI.Page
{
    ...
    private void BindDetailData(ASPxGridView detailGrid ,string productModel,string dataType)
    {
        ...
        if (ds == null)
        {
            ...
            ds = qualityProduct.GetDetailLine(dataType, startTime, endTime,roomKey,customer, productModel, string.Empty, workOrderNo,partNumber,oprline);
