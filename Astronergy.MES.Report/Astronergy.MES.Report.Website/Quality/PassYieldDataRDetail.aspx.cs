...
/// 直通率（含返工数量）报表明细数据。
/// </summary>
public partial class Quality_PassYieldDataRDetail : System.Web.UI.Page
{
    ...
    {
        {"PASS_YIELD_1_RATE",                     "从层压开始到终检的5个工段的良率(1-（返修+报废）的数量/本站总产出数量）相乘获得直通率"},
        {"LJ_PASS_YIELD_1_RATE",                  "从层压开始到终检的5个工段累计的良率相乘获得直通率"},
    };
    /// <summary>
    /// 页面标题。
    /// </summary>
