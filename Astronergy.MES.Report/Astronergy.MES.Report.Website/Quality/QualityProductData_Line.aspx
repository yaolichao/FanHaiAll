<%@ Page Language="C#" MasterPageFile="~/Master/MasterPage.master" AutoEventWireup="true"
    CodeFile="QualityProductData_Line.aspx.cs" Inherits="Quality_QualityProductData_Line" Title="<%$ Resources:lang,PageTitle %>" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:UpdatePanel ID="UpdatePanelContent" runat="server" UpdateMode="Conditional">
        ...
        <ContentTemplate>
            ...
            <table border="0" width="98%" style="margin:5px;">
                <tr>
                    ...
                    <td style="width:20%">
                        ...
                        <ContentTemplate>
                        <dxe:ASPxComboBox ID="cmbWorkPlace" runat="server" Width="77%" TextField="LOCATION_NAME" AutoPostBack="true"
                   ...
                   <td style="width:10%">
                    ...
                    <td style="width:20%">
                        ...
                        <dxe:ASPxDropDownEdit ID="ddeWorkOrderNumber" runat="server" 
                                ClientInstanceName="ddeWorkOrderNumber" EnableAnimation="False" ReadOnly="true" >
                            <DropDownWindowStyle BackColor="#EDEDED"/>
                            <DropDownWindowTemplate>
            ...
            <div class="gridview" style="text-align:center;width:1024px;overflow:auto" id="divChartPassYield">
                <asp:UpdatePanel ID="UpdatePanelChart" runat="server" UpdateMode="Conditional">
                <ContentTemplate>
                <dxchartsui:WebChartControl ID="chartPassYield" runat="server" Width="1024px" Height="300px" >
                    <SeriesSerializable>
                        <cc1:Series   >
                            <ViewSerializable>
...
<cc1:SolidFillOptions HiddenSerializableString="to be serialized" />
                    ...
                    <Legend AlignmentVertical="Top" Direction="TopToBottom" MaxHorizontalPercentage="20"></Legend>
