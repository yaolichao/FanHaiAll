<%@ Page Title="" Language="C#" MasterPageFile="~/Master/MasterPage.master" AutoEventWireup="true" CodeFile="ModuleDefectStatistics.aspx.cs" Inherits="Quality_ModuleDefectStatistics" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <ContentTemplate>
            ...
            <table class="searchbar_table" border="0" width="100%"><!-- style="margin:5px;"-->
                <tr>
                    ...
                    <td class="searchbar_table_td" style="width:20%">
                        <dx:ASPxDropDownEdit ID="checkComboBoxForType" ClientInstanceName="checkComboBoxForType" runat="server" Width="100px">
                    ...
                    <td class="searchbar_table_td" style="width:20%">
                           <dx:ASPxDropDownEdit ID="checkComboBox" ClientInstanceName="checkComboBox" runat="server" Width="200px">
                                <DropDownWindowTemplate>
                ...
                <tr>
                    ...
                    <td class="searchbar_table_td" style="width:20%">
                        <dx:ASPxDropDownEdit ID="checkComboBoxForWo" ClientInstanceName="checkComboBoxForWo" runat="server" Width="180px">
                        <DropDownWindowTemplate>
                    ...
                    <td class="searchbar_table_td" style="width:20%">
                        <dx:ASPxTextBox ID="textPartNumber" runat="server" Width="180px">
                        </dx:ASPxTextBox>
                    </td>
   ...
   <dxchartsui:WebChartControl ID="chart" runat="server" Height="300px" Width="1120px"
                    >
                    <SeriesSerializable>
...
<cc1:XYDiagram>
                        ...
                        <secondaryaxesy>
                        <cc1:SecondaryAxisY AxisID="0" Name="SecondaryAxisY" VisibleInPanesSerializable="-1">
                        <range sidemarginsenabled="True"></range>
                        </cc1:SecondaryAxisY>
                        </secondaryaxesy>
                        <secondaryaxesx>                        
                    
                    <cc1:SecondaryAxisX  AxisID="0" Name="SecondaryAxisX" VisibleInPanesSerializable="0" Alignment="Near">                                            
                    <range sidemarginsenabled="True"></range>                                            
                    </cc1:SecondaryAxisX>                                            
                    </secondaryaxesx>
                    </cc1:XYDiagram>
...
<cc1:SolidFillOptions HiddenSerializableString="to be serialized" />
      ...
      <div class="gridview">
        ...
        <dx:ASPxGridView ID="grid" ClientInstanceName="grid" runat="server" Width="100%" KeyFieldName="SEQ"
