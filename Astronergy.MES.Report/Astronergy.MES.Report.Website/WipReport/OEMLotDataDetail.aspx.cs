...
/// 批次明细数据。
/// </summary>
public partial class WipReport_OEMLotDataDetail : System.Web.UI.Page
{
    private OEMLotDataAccess _lot = new OEMLotDataAccess();
    /// <summary>
    /// 页面标题。
    /// </summary>
        ...
        else if (type == 2)
        {
            ...
            if (drs.Length > 0)
            {
                ...
                foreach (DataRow dr in drs)
                {
                    ...
                    //dr["参数值"] = string.Format("{0}A{1}{2}", strPouringSealantSupplierCode, strPouringSealantMaterial, Convert.ToString(dr["参数值"]).Substring(19));
            ...
            if (drs.Length > 0)
            {
                ...
                foreach (DataRow dr in drs)
                {
                    ...
                    //dr["参数值"] = string.Format("{0}A{1}{2}", strSilicaGelSupplierCode, strSilicaGelMaterial, Convert.ToString(dr["参数值"]).Substring(19));
