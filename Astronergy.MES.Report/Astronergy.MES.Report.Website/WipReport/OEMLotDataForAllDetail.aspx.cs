...
/// 批次明细数据。
/// </summary>
public partial class WipReport_OEMLotDataForAllDetail : System.Web.UI.Page
{
    private OEMLotDataForAllAccess _lot = new OEMLotDataForAllAccess();
    /// <summary>
    /// 页面标题。
    /// </summary>
    ...
    private void BindDetailData(int type)
    {
        ...
        DataSet dsReturn = this._lot.GetLotDetail(lotKey, type , user);
