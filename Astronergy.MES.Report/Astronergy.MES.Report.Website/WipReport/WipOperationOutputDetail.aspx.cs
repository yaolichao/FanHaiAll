...
/// 获取工序产量明细数据。
/// </summary>
public partial class WipReport_WipOperationOutputDetail : System.Web.UI.Page
{
    ...
    private void BindData()
    {
        ...
        if (dt == null)
        {
            ...
            DataSet ds = wipOuput.GetOutputDataDetail(startTime, endTime, roomName, stepName,
                                                    proId, workOrderNo, trxType, shiftName, isHistory, factoryshift, partNumber);
            if (ds != null)
            {
    ...
    protected void btnXlsExport_Click(object sender, EventArgs e)
    {
        ...
        Response.AppendHeader("content-disposition", "attachment;filename=\"OperationOutputDetail.xls\"");
